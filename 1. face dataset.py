...
face_detector = cv2.CascadeClassifier(r"F:\WORK\DOCUMENTS\INTERNSHIP PROJECT WORK\DEEP LEARNING PROJECTS\INTERNSHIP PROJECTS(1-10)\FACE RECOGNITION(9)\haarcascade_frontalface_default.xml")
